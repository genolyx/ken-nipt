...
Batch runner for low-FF experiment:
  ...
  - optionally runs full NIPT pipeline from BAM using `src/run_nipt_from_bam.sh`
"""
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    make_bam_py = _here / "lowff_make_artificial_bam.py"
    run_from_bam_sh = repo_root / "src/run_nipt_from_bam.sh"
