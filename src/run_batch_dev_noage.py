...
def run_daemon(cmd, labcode, sample_list, max_samples, intv):
    ...
    try:
        ...
        sample_df = sample_df[["SAMPLE_NAME", "WORK_DIR", "FQ1", "FQ2"]]
        samples_dic = {row["SAMPLE_NAME"]: [row['WORK_DIR'], row["FQ1"], row["FQ2"]] for _, row in sample_df.iterrows()}
...
if __name__ == "__main__":
    ...
    try:
        ...
        command = "bash /home/ken/ken-nipt/src/run_nipt_dev_noage.sh -s SAMPLE_NAME -1 FQ1 -2 FQ2 -l LABCODE -root /home/ken/ken-nipt -work WORK_DIR --detached"
